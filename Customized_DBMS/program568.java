...
class MarvellousDBMS
{
    ...
    public void AggregateMax()
    {
        ...
        System.out.println("Maximun of records in the Employee table : "+iMax);
    }
    ...
    public void AggregateMin()
    {
        ...
        System.out.println("Minimun of records in the Employee table : "+iMin);
    }
...
class program568
{
    public static void main(String Arg[]) 
    {
        ...
        while (true) 
        {
            ...
            System.out.println("9 : Maximun of all records salary");   
            System.out.println("10 : Minimum of all records salary");   
            System.out.println("11 : Update the exisiting record");   
            System.out.println("12 : Delete the table");   
            System.out.println("13 : Terminate the Marvelous DBMS");   
            System.out.println("-----------------------------------------------------------");
        }
