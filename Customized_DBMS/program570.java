...
class program570
{
    public static void main(String Arg[])
    {
        ...
        while(true)
        {
            ...
            {
                System.out.print("Enter the employee ID whose data you want to display : ");
                id = sobj.nextInt();
            ...
            {
                System.out.print("Enter the employee name whose data you want to display : ");
                name = sobj.next();
            ...
            {
                System.out.print("Enter the employee name that you want to delete : ");
                name = sobj.next(); 
            ...
            {
                System.out.print("Enter the ID of emplyee that you want to update : ");
                id = sobj.nextInt();
