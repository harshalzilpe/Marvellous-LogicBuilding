...
void man(char *name)
{
    ...
    {
        printf("Description : Used to cloase all opened file\n");
        printf("Usage : closeall\n");  
    }
    else if(strcmp(name,"lseek") == 0)
    {
        printf("Description : Used to change file offset\n");
        printf("Usage : lseek File_name ChangesInOffset StartPoint\n");  
    }
    ...
    {
        printf("ERROR : No manual entry avaiable.\n");
    }
}
